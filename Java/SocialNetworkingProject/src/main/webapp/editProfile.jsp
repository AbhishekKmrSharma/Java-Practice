                    ...
                    <div class="col-9">
                        <div class="row">
                            <div class="col-12 shadow-sm p-3 mb-5 bg-body rounded">
                                <img src="images/virat-kohli.jpg" alt="" style="max-width: 20%; border-radius: 10px; box-shadow: 0px 0px 5px #dddcdc; padding: 5px;" />
                        ...
                        <div class="row">
                            <div class="col-12 shadow-sm p-3 mb-5 bg-body rounded">
                                <div style="padding-left: 200px; padding-right: 200px">
                                    ...
                                    <form class="row gy-2 gx-3 align-items-center" action = "update">
                                        <div>
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="bi bi-person-fill"></i></div>
                                                <input type="text" class="form-control" name = "name1" id="autoSizingInputGroup" value="<%= session.getAttribute("session_name")%>" placeholder="Name">
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name = "email1" id="autoSizingInputGroup" value="<%= session.getAttribute("session_email")%>" readonly>
                                            </div>
                                        </div>
                                        <div>
